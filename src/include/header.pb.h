...
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_header_2eproto;
}  // extern "C"
namespace Prpc {
class RpcHeader;
...
/* @@protoc_insertion_point(class_definition:Prpc.RpcHeader) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "Prpc.RpcHeader"; }
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:Prpc.RpcHeader)
 private:
  class _Internal;
...
inline const ::std::string& RpcHeader::service_name() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:Prpc.RpcHeader.service_name)
...
PROTOBUF_ALWAYS_INLINE void RpcHeader::set_service_name(Arg_&& arg, Args_... args) {
  ...
  // @@protoc_insertion_point(field_set:Prpc.RpcHeader.service_name)
}
inline ::std::string* PROTOBUF_NONNULL RpcHeader::mutable_service_name()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::std::string* _s = _internal_mutable_service_name();
  // @@protoc_insertion_point(field_mutable:Prpc.RpcHeader.service_name)
  return _s;
}
...
inline ::std::string* PROTOBUF_NULLABLE RpcHeader::release_service_name() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:Prpc.RpcHeader.service_name)
...
inline void RpcHeader::set_allocated_service_name(::std::string* PROTOBUF_NULLABLE value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Prpc.RpcHeader.service_name)
}
...
inline const ::std::string& RpcHeader::method_name() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:Prpc.RpcHeader.method_name)
...
PROTOBUF_ALWAYS_INLINE void RpcHeader::set_method_name(Arg_&& arg, Args_... args) {
  ...
  // @@protoc_insertion_point(field_set:Prpc.RpcHeader.method_name)
}
inline ::std::string* PROTOBUF_NONNULL RpcHeader::mutable_method_name()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::std::string* _s = _internal_mutable_method_name();
  // @@protoc_insertion_point(field_mutable:Prpc.RpcHeader.method_name)
  return _s;
}
...
inline ::std::string* PROTOBUF_NULLABLE RpcHeader::release_method_name() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:Prpc.RpcHeader.method_name)
...
inline void RpcHeader::set_allocated_method_name(::std::string* PROTOBUF_NULLABLE value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Prpc.RpcHeader.method_name)
}
...
inline ::uint32_t RpcHeader::args_size() const {
  // @@protoc_insertion_point(field_get:Prpc.RpcHeader.args_size)
  return _internal_args_size();
}
inline void RpcHeader::set_args_size(::uint32_t value) {
  _internal_set_args_size(value);
  _impl_._has_bits_[0] |= 0x00000004u;
  // @@protoc_insertion_point(field_set:Prpc.RpcHeader.args_size)
}
